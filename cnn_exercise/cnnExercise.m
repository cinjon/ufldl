...
load STL10Features.mat; % Loads optTheta, ZCAWhite, and meanPatch
...
% convolvedFeatures is size = (hiddenSize, numConvImages, numImageRow, numImageCol)
...
% PASSED - Turning off these tests too.
