...
xRot = zeros(size(x));
xRot = u' * x; % Cinjon: Running this with y instead of x shows nothing like
               % what they have on the site
...
% --------------------------------------------------------
figure(3);
% I think they meant scatter(xHat(1, :), xHat(1, :)); because the dims aren't
% right otherwise.
...
% Running this with x or with y ... neither produce anything like what they
% show. With y, the y-axis is really small. With x, it's really large.
