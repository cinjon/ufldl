...
images = loadMNISTImages('../mnistHelper/train-images-idx3-ubyte');
labels = loadMNISTLabels('../mnistHelper/train-labels-idx1-ubyte');
...
images = loadMNISTImages('../mnistHelper/t10k-images-idx3-ubyte');
labels = loadMNISTLabels('../mnistHelper/t10k-labels-idx1-ubyte');
labels(labels==0) = 10; % Remap 0 to 10
